...
$_lang['themepackagercomponent.license'] = 'Licence';
$_lang['themepackagercomponent.license_desc'] = 'Une licence que l\'utilisateur doit accepter à l\'installation. Optionnel.';
...
$_lang['themepackagercomponent.plugin_add'] = 'Ajouter un Plugin';
$_lang['themepackagercomponent.plugin_desc'] = 'Le Plugin à inclure dans le paquet.';
$_lang['themepackagercomponent.plugin_err_ns'] = 'Veuillez sélectionner un Plugin.';
$_lang['themepackagercomponent.plugin_remove'] = 'Supprimer le Plugin';
$_lang['themepackagercomponent.plugin_remove_confirm'] = 'Êtes vous sûr de vouloir supprimer ce Plugin?';
$_lang['themepackagercomponent.plugins'] = 'Plugins';
$_lang['themepackagercomponent.plugins.intro_msg'] = '<p>Veuillez sélectionner les Plugins que vous souhaitez inclure dans le paquet. Tout évènement système associé aux Plugins sera automatiquement inclu.</p>';
...
$_lang['themepackagercomponent.readme'] = 'Lisezmoi';
$_lang['themepackagercomponent.readme_desc'] = 'Un fichier lisezmoi à montrer à l\'installation. Optionnel.';
...
$_lang['themepackagercomponent.snippet_add'] = 'Ajouter un Snippet';
$_lang['themepackagercomponent.snippet_desc'] = 'Le Snippet à inclure dans le paquet.';
$_lang['themepackagercomponent.snippet_err_ns'] = 'Veuillez sélectionner un Snippet.';
$_lang['themepackagercomponent.snippet_remove'] = 'Supprimer le Snippet';
$_lang['themepackagercomponent.snippet_remove_confirm'] = 'Êtes vous sûr de vouloir supprimer ce Snippet?';
$_lang['themepackagercomponent.snippets'] = 'Snippets';
$_lang['themepackagercomponent.snippets_custom'] = 'Snippets spécifiques';
$_lang['themepackagercomponent.snippets.intro_msg'] = '<p>Veuillez sélectionner les Snippets et ses fichiers associés. <b>Veuillez noter que vous ne devriez pas utiliser cela pour les paquets téléchargés via le gestionnaire de paquets.</b> Vous devriez utiliser l\'onglet des sous-paquets pour cela.</p>';
